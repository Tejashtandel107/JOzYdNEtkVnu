...
class InwardsController extends Controller
{
    ...
    protected $customerorder_obj,$orderitem_obj;
    ...
    public function index(Request $request)
    {
        $data = [
            ...
            'breadcrumbs'=>array("Home"=>route('admin.home'),"Inwards"=>""),
            'menuParent'=>'inwards',
            'menuChild'=>'allinward'
        ];
    ...
    public function create()
    {
        $data = [
            ...
            'breadcrumbs'=>array("Home"=>route('admin.home'),"Inwards"=>route('admin.inwards.index'),"Create"=>""),
            'menuParent'=>'inwards',
            'menuChild'=>'inward'
        ];

        list($items, $markas, $chambers, $floors, $grids, ) = $this->customerorder_obj->pluckData(["item_id","marka_id","chamber_id","floor_id","grid_id"]);
    ...
    public function showReceipt(Request $request,$id)
    {
        $data = [
            ...
            "breadcrumbs"=>array("Home"=>route('admin.home'),"Inwards"=>route('admin.inwards.index'),"Receipt"=>""),
            'menuParent'=>'inwards',
            'menuChild'=>'allinward'
        ];
        $user = Auth::user();
    ...
    public function edit(Request $request,Marka $obj_marka, $id)
    {
        ...
        $data = [
            ...
            "breadcrumbs"=>array("Home"=>route('admin.home'),"Inwards"=>route('admin.inwards.index'),"Edit"=>""),
            'menuParent'=>'inwards',
            'menuChild'=>'inward'
		];
