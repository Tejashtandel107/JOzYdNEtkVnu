...
class FullLedgerReportController extends Controller
{
    ...
    public function show(Request $request) 
    {
        $data =[
            ...
            "breadcrumbs"=>array("Home"=>route('admin.home'),"Ledger Report"=>""),
            'menuParent'=>'reports',
        ...
        return view('admin.reports.full-ledger',$data)->with(compact('request','customers','results','items','markas','user','chambers','floors','grids','company_info'));
    }
