...
class OutwardsController extends Controller
{
    ...
    public function index(Request $request)
    {
        $data = [
            ...
            'breadcrumbs'=>array("Home"=>route('admin.home'),"Outwards"=>""),
            'menuParent'=>'outwards',
    ...
    public function create()
    {
        $data = [
            ...
            'breadcrumbs'=>array("Home"=>route('admin.home'),"Outwards"=>route('admin.outwards.index'),"Create"=>""),
            'menuParent'=>'outwards',
            'menuChild'=>'outward'
        ];

        list($items, ,$chambers, $floors, $grids, ) = $this->customerorder_obj->pluckData(["item_id","chamber_id","floor_id","grid_id"]);
    ...
    public function showReceipt(Request $request,$id)
    {
        $data = [
            ...
            "breadcrumbs"=>array("Home"=>route('admin.home'),"Outwards"=>route('admin.outwards.index'),"Receipt"=>""),
            'menuParent'=>'outwards',
            'menuChild'=>'alloutward'
        ];
        $user = Auth::User();
    ...
    public function edit(Request $request,Marka $obj_marka, $id)
    {
        ...
        $data = [
            ...
            "breadcrumbs"=>array("Home"=>route('admin.home'),"Outwards"=>route('admin.outwards.index'),"Edit"=>""),
            'menuParent'=>'outwards',
            'menuChild'=>'outward'
		];
