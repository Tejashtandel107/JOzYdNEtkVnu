...
class ItemController extends Controller
{
    ...
    public function index(Request $request)
    {
        $data=[
            'pagetitle'=>"All Items",
            "breadcrumbs"=>array("Home"=>route('admin.home'),"Items"=>""),
            'menuParent'=>'items',
            'menuChild'=>'items'
        ];
    ...
    public function create()
    {
        $data=[
			...
			"breadcrumbs"=>array("Home"=>route('admin.home'),"Items"=>route('admin.items.index'),"Create"=>""),
            'menuParent'=>'items',
            'menuChild'=>'additem'
		];
    ...
    public function edit($id)
    {
        $data = [
			'pagetitle'=>"Edit Item",
			"breadcrumbs"=>array("Home"=>route('admin.home'),"Items"=>route('admin.items.index'),"Edit"=>""),
            'menuParent'=>'items',
            'menuChild'=>'items'
        ];
