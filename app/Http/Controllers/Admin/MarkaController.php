...
class MarkaController extends Controller
{
    ...
    public function index(Request $request)
    {
        $data=[
            'pagetitle'=>"All Marka",
            "breadcrumbs"=>array("Home"=>route('admin.home'),"Markas"=>""),
            'menuParent'=>'items',
        ...
        $search_fields = array('marka.name','i.name');
        if($keyword != "") {
    ...
    public function create()
    {
        $data=[
			...
			"breadcrumbs"=>array("Home"=>route('admin.home'),"Markas"=>route('admin.item-marka.index'),"Create"=>""),
            'menuParent'=>'items',
            'menuChild'=>'item-markas'
		];
        
        list($items,$markas , , , , ) = $this->marka_obj->pluckData(["item_id"]);        
    ...
    public function edit($id)
    {
        $data = [
			...
			"breadcrumbs"=>array("Home"=>route('admin.home'),"Markas"=>route('admin.item-marka.index'),"Edit"=>""),
            'menuParent'=>'items',
            'menuChild'=>'item-markas'
        ];

        $marka = Marka::findOrFail($id);
        list($items, , , , , ) = $this->marka_obj->pluckData(["item_id"]);
