    ...
    * Display a listing of the resource.
    ...
    public function index(Request $request)
    {
        ...
        $data = [
            ...
            "breadcrumbs"=>array("Home"=>route('admin.home'),"Customers"=>route('admin.customers.index')),
        ...
        $search_fields = array('companyname','address','phone');
    ...
    public function create()
    {
        $data = [
            ...
            "breadcrumbs"=>array("Home"=>route('admin.home'),"Customers"=>route('admin.customers.index'),"Create"=>""),
            'menuParent'=>'customers',
            'menuChild'=>'customers'
        ];
    ...
    public function store(CustomerRequest $request)
    {
        ...
        if($this->customer_obj->store($request_arr)) {
            ...
            return response()->json(array('message' => $message, 'type' => $type,'redirectUrl'=>$redirectUrl,'imageLocation'=>Helper::getProfileImg($request_arr['photo']))); 
    	}
    ...
    public function createUser($id)
    {
        $data = [
            ...
            "breadcrumbs"=>array("Home"=>route('admin.home'),"Customers"=>route('admin.customers.index'),"Edit Customers"=>route('admin.customers.edit',$id),"Create Customer User"=>""),
            'menuParent'=>'customers',
            'menuChild'=>'customers'
        ];
        $customer_id = $id;
    ...
    public function edit($id)
    {
        $data = [
            ...
            "breadcrumbs"=>array("Home"=>route('admin.home'),"Customers"=>route('admin.customers.index'),"Edit"=>""),
            'menuParent'=>'customers',
            'menuChild'=>'customers'
		];
    ...
    public function update(CustomerRequest $request, $id)
    {
        ...
        return response()->json(array('message' => $message, 'type' => $type,'imageLocation'=>Helper::getProfileImg($response['photo'])));                
    ...
    public function editUser($id)
    {
        ...
        $data = [
            ...
            "breadcrumbs"=>array("Home"=>route('admin.home'),"Customers"=>route('admin.customers.index'),"Edit Customers"=>route('admin.customers.edit',$customer_id),"Edit Customer User"=>""),
            'menuParent'=>'customers',
            'menuChild'=>'customers'
        ];
    ...
    public function openModal(Request $request)
    {
        ...
        list( , , , , , $customers) = $this->customer_obj->pluckData(["customer_id"]);
