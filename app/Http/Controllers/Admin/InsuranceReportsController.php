...
class InsuranceReportsController extends Controller
{
    ...
    public function show(Request $request)
    {
        ...
        $data = [
            ...
            "breadcrumbs"=>array("Home"=>route('admin.home'),"Statement Of Insurance"=>""),
            'menuParent'=>'reports',
        ...
        if($request->filled('c') && ($request->filled('from') || $request->filled('to'))) {
            ...
            //$results = $this->customerorder_obj->getInsuarnce($request,$from,$to);
            ...
            if($keyword != "") {
                $search_fields = array('i.name','m.name','oi.vakkal_number');
        ...
        return view('admin.reports.insurance',$data)->with(compact('user','request','customers','items','markas','results','period','company_info'));
    }
