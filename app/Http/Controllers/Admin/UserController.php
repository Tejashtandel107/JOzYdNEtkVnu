...
{
    protected $customerorder_obj,$user_obj;
    ...
    public function index(Request $request) 
    {
        ...
        $data = [
            ...
            "breadcrumbs"=>array("Home"=>route('admin.home'),"All Admins"=>""),
        ...
        $search_fields = array('firstname','lastname','username','email');
    ...
    public function create() 
    {
        $data=[
            ...
            "breadcrumbs"=>array("Home"=>route('admin.home'),"All Admins"=>route('admin.admins'),"Create"=>""),
            'menuParent'=>'customers',
            'menuChild'=>'admins'
        ];
    ...
    public function editAdmin($id) 
    {
        ...
        $data = [
            ...
            "breadcrumbs"=>array("Home"=>route('admin.home'),"All Admins"=>route('admin.admins'),"Edit Admin"=>""),
            'menuParent'=>'customers',
            'menuChild'=>'admins'
        ];
        if($user) {
    ...
    public function edit($id) 
    {
        if(Auth::check())
        {
            $data = [
    			...
    			"breadcrumbs"=>array("Home"=>route('admin.home'),"My Profile"=>""),
                'menuParent'=>'user',
                'menuChild'=>'user'
            ];
    ...
    {        
        ...
        return response()->json(array('message' => $message, 'type' => $type,'imageLocation'=>Helper::getProfileImg($request_arr['logo'])));
    }
