...
<div class="page-content fade-in-up">
    <div class="ibox mb-2">
        ...
        <?php echo e(Form::model($request, array('url' =>route('user.outwards.index'),'method'=>'get','id'=>'form-filter','autocomplete'=>'off'))); ?>
        ...
        <div class="ibox-body">
            <div class="flexbox mb-2">
                ...
                <div class="pull-right">
                    <a class="btn btn-dark btn-rounded btn-air mb-2" onclick="printList('<?php echo e(route('user.outwards.print',$request->all())); ?>')" href="javascript:void(0)"><i class="fa fa-print"></i> Print </a>
                </div>
            </div>
                ...
                <?php if(isset($customer_orders) && $customer_orders->count()>0): ?>
                    <?php $__currentLoopData = $customer_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer_order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                            ...
                            <td>                                                                
                                <a href="<?php echo e(route('user.outwards.showReceipt',$customer_order->customer_order_id)); ?>" title="Receipt"><button class="btn btn-outline-dark btn-icon-only btn-sm mb-2"><i class="ti ti-printer"></i></button></a> &nbsp;                                  
                            </td>
                        </tr>
...
<?php $__env->startSection('page-scripts'); ?>
	<?php echo Html::script('/assets/web/js/outwards/index.js'); ?>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('web.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/gurukrupafoodproducts/application/resources/views/web/outwards/index.blade.php ENDPATH**/ ?>