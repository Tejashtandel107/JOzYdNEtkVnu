...
<div class="page-content fade-in-up">
    <div class="ibox mb-2">
        ...
        <?php echo e(Form::model($request, array('url' =>route('admin.outwards.index'),'method'=>'get','id'=>'form-filter','autocomplete'=>'off'))); ?>
        ...
        <div class="ibox-body">
            <div class="flexbox mb-2">
                ...
                <div class="pull-right">                                                                        
                    <a class="btn btn-primary btn-rounded btn-air mb-2" href="<?php echo e(route('admin.outwards.create')); ?>">Add Outward</a> &nbsp;&nbsp;
                    <a class="btn btn-dark btn-rounded btn-air mb-2" onclick="printList('<?php echo e(route('admin.outwards.print',$request->all())); ?>')" href="javascript:void(0)"><i class="fa fa-print"></i> Print </a>
                </div>
            </div>
                ...
                <?php if(isset($customer_orders) && $customer_orders->count()>0): ?>
                    <?php $__currentLoopData = $customer_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer_order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($customer_order->delivery_address); ?></td>
                            ...
                            <td>                                
                                ...
                                <button class="btn btn-outline-danger btn-icon-only btn-sm mb-2" onclick="deleteCustomerOrder( '<?php echo e(route('admin.outwards.destroy',$customer_order->customer_order_id)); ?>','<?php echo e($customer_order->customer_order_id); ?>' );" title="Delete"><i class="la la-trash"></i></button> &nbsp;                                                                
...
<?php $__env->startSection('page-scripts'); ?>
	<?php echo Html::script('/assets/admin/js/outwards/index.js'); ?>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/gurukrupafoodproducts/application/resources/views/admin/outwards/index.blade.php ENDPATH**/ ?>