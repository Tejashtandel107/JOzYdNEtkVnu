...
<?php $__env->startSection('page-css'); ?>
    <?php echo Html::style('/assets/admin/css/reports/insurance-reports.css'); ?>
...
<div class="page-content fade-in-up">
    <div class="ibox mb-2 noprint">
        ...
        <?php echo e(Form::model($request ,['method'=>'GET','route' => ['admin.reports.insurance-report.show'],'id'=>"insurance-form"])); ?>
                    ...
                    <div class="d-flex justify-content-between">
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="form-group mr-2 mb-2">
                               ...
                               <?php echo Form::select('c', (array(""=>"Select") + $customers->pluck('fullname','customer_id')->toArray()), null , ['class' => 'form-control','required' => true]); ?>
...
<?php $__env->startSection('page-scripts'); ?>
    <?php echo Html::script('/assets/admin/js/reports/insurance.js'); ?>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/gurukrupafoodproducts/application/resources/views/admin/reports/insurance.blade.php ENDPATH**/ ?>