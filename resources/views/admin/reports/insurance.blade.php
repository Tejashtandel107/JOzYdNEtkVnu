...
@section('page-css')
    {!! Html::style('/assets/admin/css/reports/insurance-reports.css') !!}
@endsection
...
<div class="page-content fade-in-up">
    <div class="ibox mb-2 noprint">
        ...
        {{ Form::model($request ,['method'=>'GET','route' => ['admin.reports.insurance-report.show'],'id'=>"insurance-form"]) }}
            <div id="notify"></div>
            <div class="row">                                  
                        ...
                        <div class="d-flex flex-wrap">
                            <div class="mr-2 mb-2" style="width: 270px;">
                                ...
                                <div class="input-group date">
                                    {!! Form::text('from', null , array('class' => 'form-control datepicker','required' => true,'placeholder' => 'From','autocomplete'=>'off')) !!}
                                    <span class="input-group-addon pl-2 pr-2">to</span>
                                    {!! Form::text('to', null , array('class' => 'form-control datepicker','placeholder' => 'To','autocomplete'=>'off')) !!}
                                </div>        
                            </div>
                            <div class="form-group mr-2 mb-2">
                                <label class="pr-1">Customer:</label>
                               {!! Form::select('c', (array(""=>"Select") + $customers->pluck('fullname','customer_id')->toArray()), null , ['class' => 'form-control','required' => true]) !!}
                            </div>
                            <div class="mr-2 mb-2">
                            ...
                            <div class="mr-2 mb-2">
                                ...
                                <div class="input-group-icon input-group-icon-left">
                                    ...
                                    {!! Form::text('q',null, array('class' => 'form-control','placeholder' => 'Vakkal,Item,Marka')) !!}
                                </div>
                            </div>  
    ...
    <div class="ibox" id="printbox">
        <div class="ibox-body text-right">
            ...
            @if(!count($request->all())>0)
                <div class="text-left mt-3 alert alert-danger has-icon"><i class="fa fa-exclamation-circle alert-icon noprint"></i> Please select any filters to generate report. </div>                
...
@section('page-scripts')
    {!! Html::script('/assets/admin/js/reports/insurance.js') !!}
@endsection