                ...
                <div class="align-self-center noprint mb-2">
                    <form class="form-inline" action="javascript:void(0);">
                        ...
                        <div class="input-group date">
                            {!! Form::text('from_date',$from, array('class' => 'form-control datepicker mr-sm-2 mb-0','id'=>'from_date','placeholder' => 'From','autocomplete'=>'off')) !!}                            
                        </div>&nbsp;&nbsp;&nbsp;
                        <label class="">To &nbsp;</label>
                        <div class="input-group date">
                            {!! Form::text('to_date',$to, array('class' => 'form-control datepicker mr-sm-2 mb-0','id'=>'to_date','placeholder' => 'To','autocomplete'=>'off')) !!}                            
                        </div>    
