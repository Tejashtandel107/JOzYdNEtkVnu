    ...
    <div class="row">
        <div class="{{(isset($user)) ? 'col-lg-8' : 'col-lg-12'}}" id="user-details">
            <div class="ibox ibox-fullheight">
                ...
                @if(isset($user))
                    {{ Form::model($user ,['method'=>'PATCH' , 'files'=>true, 'route' => ['admin.admins.update', $user->user_id],'id'=>"user-form"]) }}
                @else
                    {!! Form::open(array('files'=>true, 'route' => 'admin.admins.store', 'id' => 'user-form','autocomplete' => 'off')) !!}
                @endif
                <div class="ibox-body">
                    <div id="notify"></div>
                     <div class="row">
    ...
    @if(isset($user))
        <div class="col-md-4" id="changepass">
            <div class="ibox">
                ...
                <div id="notify"></div>
                {!! Form::open(array('route' => ['admin.admins.changepass', $user->user_id], 'method'=>'POST', 'id' => 'reset-password-form', 'name' => 'reset-password-form','autocomplete' => 'off')) !!}
                <div class="ibox-body">
...
@section('page-scripts')
    {!! Html::script('/assets/admin/js/user/create.js') !!}
    @if (session('type'))
