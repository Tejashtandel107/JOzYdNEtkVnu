...
@section('pagecontent')
    ...
    <div class="page-content fade-in-up">
        <div class="ibox">
            <div class="ibox-body">
                <div id="notify"></div>
                {{ Form::model($request,array('url' =>route('admin.items.index'),'method'=>'get','id'=>'form-filter')) }}
                <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
                    ...
                    <div class="d-flex flex-wrap">
                        <div class="form-inline flex-grow mb-2">
                            ...
                            {!! Form::select('show', (array("25"=>"25","50"=>"50","100"=>"100")), $show , ['class' => 'form-control mr-2 mb-2', 'onchange'=>'formsubmit()']) !!}                            
                        </div>
...
@section('page-scripts')
	{!! Html::script('/assets/admin/js/items/index.js') !!}
@endsection
