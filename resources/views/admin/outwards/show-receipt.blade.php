...
@section('page-css')
    {!! Html::style('/assets/web/css/outwards/show-receipt.css') !!}
@endsection
        ...
        <div class="ibox-body text-black">
            <div class="d-flex justify-content-between">
                <div class="noprint mb-3">
                    <a class="btn btn-blue" href="{{ route('admin.outwards.edit',$customer_order->customer_order_id) }}" title="Edit"><i class="fa fa-edit"></i> Back To Edit</a>
                </div>
                <div class="noprint mb-3">
            ...
            @if(isset($outward_items) && $outward_items->count() > 0)
                ...
                <div class="border border-black {{($loop->first) ? '' : 'print-margin-top pagebreak'}}">
                    {{--<div class="text-center top-title border-bottom p-1">|| {{config('constant.TAGLINE')}} ||</div>--}}
                    ...
                    <div class="w-100 receipt-body-main">
                        ...
                        <div class="d-flex border-bottom justify-content-between">
                            ...
                            <div class="pr-2 print-remark"><b>By :</b> {{ $customer_order->username }} On {{Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $customer_order->order_created_date)->format('d/m/Y H:i')}}</div>
                        </div>
...
@section('page-scripts')
    {!! Html::script('/assets/admin/js/outwards/show-receipt.js') !!}
    @if (session('type'))
