...
<head>
    <title>{{ config('app.name')}} : Print Outwards</title>
    ...
    {{ Html::style('/assets/admin/css/reports/inwards-outwards.css') }}
</head>
<body>    
<div class="ibox">
    <div class="ibox-body">
        ...
        <h2 class="text-center">Outwards</h2>
            ...
            <table class="w-100" border="1">
                <thead>
                    <tr>
                        ...
                        <td class="font-weight-bold border-left bg">Outward Date</td>
                        <!-- <td class="font-weight-bold border-left bg">Customer</td> -->
                        <td class="font-weight-bold border-left bg">Order By</td>
                ...
                ?>
                    <tr>
                        ...
                        <td class="border-left">{{ $customer_order->order_by }}</td>                            
                        <td class="border-left">{{ $customer_order->additional_charge }}</td>
                    </tr>
                @endforeach
                    <tr>
                        <td class="border-right border-bottom-0" colspan="4"></td>                            
                        <td><b>Total:</b></td>
