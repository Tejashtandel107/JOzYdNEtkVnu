...
{{ Html::style('/assets/app/vendors/line-awesome/css/line-awesome.min.css') }}
{{ Html::style('/assets/app/vendors/themify-icons/css/themify-icons.css') }}
{{ Html::style('/assets/app/vendors/toastr/toastr.min.css') }}
<!-- PLUGINS STYLES-->
@yield('plugin-css')
<!-- THEME STYLES-->
{{ Html::style('/assets/web/css/main.css') }}
{{ Html::style('/assets/web/css/app.css') }}
<!-- PAGE LEVEL STYLES-->
    @yield('page-css')
</head>
