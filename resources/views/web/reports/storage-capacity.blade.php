...
@section('page-css')
    {!! Html::style('/assets/admin/css/reports/stocks-reports.css') !!}
@endsection
...
<div class="page-content fade-in-up">
    <div class="ibox mb-2 noprint">
        ...
        {{ Form::model($request,array('url' =>route('admin.reports.stock-report.show'),'method'=>'get','id'=>'form-filter')) }}
            <div class="flexbox">
                <div class="flexbox noprint">
                    <div class="form-group mr-2">                        
                        <label class="pr-1">Chamber:</label>
                        {!! Form::select('ch', (array(""=>"Select Chamber","all"=>"View All") + $chambers), null , ['class' => 'form-control','onchange'=>'formsubmit()']) !!}                        
                    </div>
                    <div class="form-group">                        
                        <label class="pr-1">Floor:</label>
                        {!! Form::select('fl', (array(""=>"Select Floor","all"=>"View All") + $floors), null , ['class' => 'form-control','onchange'=>'formsubmit()']) !!}
                    </div>
                </div>                
            </div>
        {{ Form::close() }}
...
@section('page-scripts')
    {!! Html::script('/assets/admin/js/inwards/show.js') !!}
    @if (session('type'))
