...
@section('page-css')
    {!! Html::style('/assets/web/css/reports/fullledger-reports.css') !!}
@endsection
...
<div class="page-content fade-in-up">
    <div class="ibox mb-2 noprint">
        ...
        {{ Form::model($request,array('url' =>route('user.reports.full-ledger.show'),'method'=>'get','id'=>'form-filter','autocomplete'=>'off')) }}
            <div id="notify"></div>
            <div class="row">                                  
...
@section('page-scripts')
    {!! Html::script('/assets/web/js/reports/full-ledger.js') !!}
@endsection