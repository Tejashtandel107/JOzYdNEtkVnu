...
<?php            
                    ...
                    if($result->isInward()){
                        //Inward Case
                        $total_inward_weight+=$total_weight;     
                    }
                    if($result->isOutward()){
                        //Outward Case
                        $total_outward_weight+=$total_weight;                          
                    }
?>
                    <tr>
                        ...
                        <td>{{ Helper::formatWeight($total_weight) }}</td>
                ...
                @endforeach
                    <tr class="text-right">
                        <td colspan="10"></td>
                        <td>Total Balance:</td>
                        <td>{{ Helper::formatWeight($ledger_results->sum('total_balance_weight')) }}</td>
                    </tr>
                    <tr class="text-right">
                        <td colspan="10"></td>
                        <td>Total Inward:</td>
                        <td>{{ Helper::formatWeight($total_inward_weight) }}</td>
                    </tr>
                    <tr class="text-right">
                        <td colspan="10"></td>
                        <td>Total Outward:</td>
                        <td>{{ Helper::formatWeight($total_outward_weight) }}</td>
                    </tr>
            @endforeach
        @else
        <tr>
