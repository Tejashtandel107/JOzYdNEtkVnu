...
@section('page-css')
    {!! Html::style('/assets/web/css/reports/insurance-reports.css') !!}
@endsection
...
<div class="page-content fade-in-up">
    <div class="ibox mb-2 noprint">
        ...
        {!! Form::hidden('customer_id', (isset($customer_id) ? $customer_id : null) , array('id' => 'customer_id')) !!}
        {{ Form::model($request ,['method'=>'GET','route' => ['user.reports.insurance-report.show'],'id'=>"insurance-form"]) }}
            <div id="notify"></div>
            <div class="row">                                  
...
@section('page-scripts')
    {!! Html::script('/assets/web/js/reports/insurance.js') !!}
@endsection