<?php
  return [
    ...
    'USER_ROLE_LABELS'=>[
      1=>array("role"=>"superadmin","display_name"=>"Super Admin","color"=>"primary"),
      2=>array("role"=>"admin","display_name"=>"Admin","color"=>"success"),
      3=>array("role"=>"user","display_name"=>"User","color"=>"warning"),
    ],
